    ...
    const members = [
        {
            ...
            gardienne: "Leader dans l'âme, danseuse expérimentée et championne du lancer de chaussure.",
        ...
        {
            name: "SOO",
            role: "Trésorière / Danseuse",
            gardienne: "Personnalité explosive, souriante mais un peu trop pipelette parfois...",
            defaultImg: "images/soo.png",
            hoverImg: "images/soo.png",
            defaultIcon: "https://static.vecteezy.com/system/resources/previews/036/631/694/non_2x/sun-free-vector.png",
            hoverIcon: "https://static.vecteezy.com/system/resources/previews/036/666/670/non_2x/moon-free-vector.png",
            quote: "Les chiffres sont une poésie silencieuse.",
            song : "Passion fruit - Jeff Sature",
            socialLinks: {
        ...
        },
        {
            ...
            gardienne: "Métalleuse, elle vient d'un pays froid mais a une voix et une énergie on fire.",
        ...
        //},
        {
            name: "GEMMA",
            role: "Danseuse / Chanteuse",
            gardienne: "Pour elle, tout ça n'est qu'un jeu dont elle est le boss final (ou la boss lady).",
        ...
        },
        {
            ...
            gardienne: "Championne du multitâche, entrepreneuse et artiste qui saura mettre des paillettes dans vos vies.",
        ...
        //},
        {
            name: "HELENE",
            role: "Danseuse / Chanteuse",
            gardienne: "J'ai fait le site je veux pas me jeter des fleurs vous verrez par vous même bisous.",
    ...
    members.forEach(function(member) {
        ...
        card.innerHTML = `
            ...
            <div class="p-6">
                ...
                <p class="text-gray-300 mb-4">${member.gardienne}</p>
